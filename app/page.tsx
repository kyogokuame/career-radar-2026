...
const roles: Role[] = [
  ...
  {id:"sierra-gtm-operations",company:"Sierra",title:"GTM Operations",href:"https://www.linkedin.com/jobs/view/4446733630/",source:"LinkedIn · Sierra HR",date:"8/24",work:"负责新市场商业案例与执行计划、产品表现的财务/数据分析、年度规划框架，以及 Sales、Marketing、Product、Engineering 间的跨职能经营推进。",salary:"未公开；面谈核对现金、股权数量与行权条款",onsite:"东京现场办公；公司以线下协作为主",commute:"东京办公室（具体区域待 HR 确认）",distance:"待确认",management:"高级个人贡献者；跨职能战略、经营与执行",reports:"无",memo:{title:"HR 面谈备忘 · Sierra GTM Operations",items:["为什么现在招聘此岗位？未来 6–12 个月日本团队最优先解决的新市场、客户或经营问题是什么？","该岗位在前 90 天和第一年分别以什么结果衡量成功？是市场进入、pipeline、客户采用、营收、续约，还是内部经营效率？","职责在商业规划、数据/财务分析、客户项目交付和商业 ownership 之间如何分配？上线后的客户成果由谁负责？","直属汇报对象是谁？东京团队目前的规模和职能构成如何？哪些决策可由日本团队独立做，哪些须经由 SF / 全球团队？","公司如何在东京团队落实 Intensity 与 Family？常态工时、客户紧急响应、美国时区会议、出差及周末工作的实际频率如何？","东京办公室的准确地点、现场出勤节奏和客户现场比例分别是多少？","近期国际扩张的优先级如何排序：日本、东南亚与其他市场分别由谁覆盖？是否存在面向中文客户或大中华区的长期探索，还是当前明确聚焦日本与东南亚？","薪酬的固定、奖金/变量和股权构成是什么？在 offer 阶段能否提供完全稀释后持股比例、vesting、行权窗口、行权价与日本税务处理？","后续面试轮次、case 或客户场景考核是什么？HR 对我的背景是否已有顾虑，尤其是 5–10 年经验要求，可否尽早说明？"]},fit:"高",reason:"咨询 + ByteDance 商业化策略/运营的连续性最强，是进入企业级 AI Agent 的 GTM/经营中枢的一跳。职位明确要求 5–10 年经验，需用两年以上咨询、跨职能规划和商业化成果弥补总年限差距。主要取舍是 Sierra 将 Intensity 列为核心价值，且客户交付与现场协作可能带来持续高工时；HR 面谈需先验证岗位 ownership、日本团队的决策边界、实际工作方式、国际扩张范围与股权条款。",status:"面谈已排期",tags:["主线 AI","GTM / BizOps","AI Agent","面谈已排期"]},
