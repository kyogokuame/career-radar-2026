...
export const candidates: Candidate[] = [
  ...
  {id:"c-aws-gametech-gtm",track:"C",company:"Amazon Web Services (AWS)",title:"Principal Worldwide GTM Specialist, GameTech, WWSO Visual Computing",href:"https://www.amazon.jobs/en-gb/jobs/10438929/principal-worldwide-gtm-specialist-gametech-wwso-visual-computing-advanced-computing-aws",source:"LinkedIn MCP",location:"东京·区待确认",workplace:"东京（官方职位页仅披露 Tokyo）",commute:"办公区待确认；Google Maps 公交时间随实际办公地与出发时间变化",roleType:"全球游戏云 / GameTech GTM / 开发商与发行商合作",why:"LinkedIn 与 Amazon.jobs 均显示开放。岗位拥有 AWS GameTech 的全球 GTM 策略及所在地端到端销售周期，直接连接开发商、工作室、发行商、伙伴与产品路线图，并向全球 Visual Computing 团队和高层汇报；是游戏/IP 主线极高杠杆的跨境商业化岗位。",gate:"硬门槛为视频游戏或相邻行业 10 年以上技术型 BD/企业销售、游戏行业深度与高管关系；东京办公、N1+ 日语及商务英语要求明确。需核验客户地域、日英中使用比例、是否接受相邻科技商业化背景，以及 18–24 个月转为更广泛全球职责的路径；按长期高门槛目标处理。",verdict:"条件式",stage:"长期目标",scannedOn:"2026-09-16"},
];
