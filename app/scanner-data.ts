...
export const candidates: Candidate[] = [
  ...
  { id:"a-linkedin-pathology-pm", track:"A", company:"病理 AI 企业（职位由 LinkedIn 发布）", title:"AI Product Manager（病理 AI 产品战略）", href:"https://www.linkedin.com/jobs/view/4456779260/", source:"LinkedIn MCP", location:"东京 / 远程", roleType:"医疗 AI 产品战略", why:"LinkedIn 搜索发现的医疗 AI 产品岗位；如果职位范围包含产品战略与实际采用，可补强主线 A 的产品资本。", gate:"先核验实际雇主、产品成熟度、产品 Owner 范围与医疗行业经验要求。", verdict:"条件式" },
